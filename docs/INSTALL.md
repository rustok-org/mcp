...
podman run -it --rm \
  ...
  ghcr.io/rustok-org/rustok-wallet-tui:v0.8.3 create-wallet
```
  ...
  "mcpServers": {
    "rustok": {
      ...
      "args": ["run", "-i", "--rm",
               ...
               "ghcr.io/rustok-org/rustok-wallet-tui:v0.8.3"]
    }
  }
}
```
...
```bash
docker pull ghcr.io/rustok-org/rustok-wallet-tui:v0.8.3
