...
> only (`v0.10.0`, `v0.10`, `v0`), on purpose: the installer pins the exact digest
...
podman run -it --rm \
  ...
  ghcr.io/rustok-org/rustok-wallet-tui:v0.10.0 create-wallet
```
...
```bash
docker pull ghcr.io/rustok-org/rustok-wallet-tui:v0.10.0
