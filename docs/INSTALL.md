...
> only (`v0.9.7`, `v0.9`, `v0`), on purpose: the installer pins the exact digest
...
curl --proto '=https' --tlsv1.2 -fsSL \
  https://raw.githubusercontent.com/rustok-org/mcp/wallet-tui-v0.9.7/scripts/install.sh | sh
```
...
podman run -it --rm \
  ...
  ghcr.io/rustok-org/rustok-wallet-tui:v0.9.7 create-wallet
```
  ...
  "mcpServers": {
    "rustok": {
      ...
      "args": ["run", "-i", "--rm",
               ...
               "ghcr.io/rustok-org/rustok-wallet-tui:v0.9.7"]
    }
  }
}
```
...
```bash
docker pull ghcr.io/rustok-org/rustok-wallet-tui:v0.9.7
