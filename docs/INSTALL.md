...
> only (`v0.8.5`, `v0.8`, `v0`), on purpose: the installer pins the exact digest
...
curl --proto '=https' --tlsv1.2 -fsSL \
  https://raw.githubusercontent.com/rustok-org/mcp/wallet-tui-v0.8.5/scripts/install.sh | sh
```
...
```bash
curl --proto '=https' --tlsv1.2 -fsSL \
  https://raw.githubusercontent.com/rustok-org/mcp/wallet-tui-v0.8.5/scripts/install.sh -o install.sh
...
podman run -it --rm \
  ...
  ghcr.io/rustok-org/rustok-wallet-tui:v0.8.5 create-wallet
```
  ...
  "mcpServers": {
    "rustok": {
      ...
      "args": ["run", "-i", "--rm",
               ...
               "ghcr.io/rustok-org/rustok-wallet-tui:v0.8.5"]
    }
  }
}
```
...
```bash
docker pull ghcr.io/rustok-org/rustok-wallet-tui:v0.8.5
